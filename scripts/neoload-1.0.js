...
*/
function __getVirtualUserID() {
   return context.currentVU.id;
}

/**
* Returns the name of the virtual user path name which is being executed. Matches the context value: context.currentVU.name
*/
function __getUserPathName() {
   return context.currentVU.name;
}
